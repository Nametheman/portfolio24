  ...
  return (
    <div className="px-8 py-[3.5rem]">
      <div className="flex items-center justify-between ">
        <Socials />
        <div></div>
        <div className="border-8 border-black w-[300px] h-[300px] rounded-full flex justify-center items-center borderAnimate overflow-hidden">
          <Image
            src={photo}
            alt="my_photo"
            width={2000}
            height={2000}
            className="rounded-full h-[310px] w-[310px] object-cover"
          />
        </div>
      </div>
      <div className="mt-10">
